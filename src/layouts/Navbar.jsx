...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-base-100 shadow-sm transition-all duration-700 ease-in-out">
        ...
        {user ? (
          <div className="flex items-center gap-2">
            ...
            <div className="dropdown dropdown-end">
              <div tabIndex={0} role="button" className="btn btn-ghost btn-circle hover:scale-105 transition">
              ...
              <div tabIndex={0} className="card card-compact dropdown-content bg-base-100 z-10 mt-3 w-52 shadow transition-all duration-500">
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-10 mt-3 w-52 p-2 shadow transition-all duration-300">
          ...
          <div className="flex gap-3">
            <Link to="/login" className="btn btn-secondary transition hover:scale-105">Login</Link>
            <Link to="/register" className="btn btn-secondary transition hover:scale-105">Register</Link>
          </div>
        )}
      </div>
    </div>
